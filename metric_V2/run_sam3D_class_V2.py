...
from sam3D_class_V2 import SAM3DReconstructor
...
this_out_dir = os.path.join(SAM3D_ROOT, "Outputs_V2", "mouse_output") # 输出目录示例，这里改成了 pejoy_output/case_001，避免和之前的 cookie_output 混淆，实际使用时可以改成任意路径
