...
# Config
# ============================================================
RGB_PATH = "/mnt/dct/SKU/soda_cookie/rgb/1775641324013.jpg"
DEPTH_PATH = "/mnt/dct/SKU/soda_cookie/depth/1775641324013.png"
MASK_PATH = "/mnt/dct/SKU/soda_cookie/masks/maskdata/1775641324013.png"
...
def main():
    ...
    raw_sam_path = os.path.join(OUT_DIR, "sam3d_raw.ply") # SAM3D原始点云的PLY文件路径，包含从SAM3D模型生成的未经处理的点云数据，通常用于后续的对齐和评估步骤
